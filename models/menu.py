...
if session.lang=='en-us':
	...
	response.meta.keywords = 'ambient,arhitect,arhitectura,baie,birouri,bucatarie,camera,casa,cladire,comercial,concept,constructie,constructii civile,desen,design,detaliu,exact,exterioare,fabrica,fatade,garduri,hala,idei,industrial,interioare,linie,machete,masura,plan,planse,proiectare,proiecte,randari,remodelare,rezidential,scari,sala,sufragerie'
response.meta.generator = 'Web2py Framework'
